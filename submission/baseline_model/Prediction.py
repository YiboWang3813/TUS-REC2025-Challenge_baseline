...
class Prediction():  
    ...
    def generate_prediction_DDF(self, frames,landmark):
        ...
        pred_global_allpts_DDF1 = cal_global_allpts(transformation_global,self.tform_calib_scale,self.image_points)
        # Global displacement vectors for landmark reconstruction
        pred_global_landmark_DDF1 = cal_global_landmark(transformation_global,landmark,self.tform_calib_scale)
        # Local displacement vectors for pixel reconstruction
        pred_local_allpts_DDF1 = cal_local_allpts(transformation_local,self.tform_calib_scale,self.image_points)
        # Local displacement vectors for landmark reconstruction
        pred_local_landmark_DDF1 = cal_local_landmark(transformation_local,landmark,self.tform_calib_scale)
